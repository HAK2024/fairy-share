...
const PaymentSummary = ({
  ...
  return (
    <div className='w-full rounded-sm border-[1px] border-slate-400 bg-slate-100 px-3 py-4 md:w-2/3 md:px-8 md:py-4'>
      ...
      <div className='flex flex-col gap-4 pt-4'>
        {balanceSummary.map((payer) => (
          <div
            className='flex items-center justify-between gap-3 border-b-[1px] border-dotted border-slate-400 pb-2 last:border-0 md:gap-6'
            key={payer.payerId}
          >
            <div className='flex w-56 items-center justify-between gap-2'>
              <UserDisplay
