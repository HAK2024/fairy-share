  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button:
          'h-7 w-7 border border-input bg-background hover:bg-accent hover:text-accent-foreground bg-transparent p-0 opacity-50 hover:opacity-100 text-sm inline-flex items-center justify-center whitespace-nowrap rounded-md font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
